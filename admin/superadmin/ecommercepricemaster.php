...
$status = FALSE;
if ( authorize($_SESSION["access"]["MASTER"]["ECOMMERCEPRICEMASTER"]["create"]) || 
authorize($_SESSION["access"]["MASTER"]["ECOMMERCEPRICEMASTER"]["edit"]) || 
authorize($_SESSION["access"]["MASTER"]["ECOMMERCEPRICEMASTER"]["view"]) || 
authorize($_SESSION["access"]["MASTER"]["ECOMMERCEPRICEMASTER"]["delete"]) || 
authorize($_SESSION["access"]["MASTER"]["ECOMMERCEPRICEMASTER"]["approval"])) {
 $status = TRUE;
}
...
<div class="row heading-bg">
  <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
    <h5 class="txt-dark">Ecommerce Price Master
    </h5>
  </div>
  <!-- Breadcrumb -->
...
<table style="width:100%" id="example" class="table table-hover display  pb-30" >
  <thead>
    <tr>
       ...
       <th>Main Category</th>    <th>Image</th> 
  ...
  <tbody>
    ...
    <tr>
     ...
     <td> <?php echo $row['maincat']; ?> </td> 
      ...
      <td style="padding: 10px;width: 20%"><label><a href="#" class="hover" data-target="#view<?php echo $row["id"]; ?>" data-toggle="modal" id="<?php echo $row["id"]; ?>"><?php echo $row['productcode']; ?>  - <?php echo $row["name"]; ?></a></label></td>

  <td> <?php echo $row['description']; ?> </td>
   
      <?php include 'modal/viewpricemaster.php';?>  
