$().ready(function() {
    $( "#country" ).change(function() {
    	...
    	$('#city').append('<option value="0">Please choose a Item SubGroup</option>');
	...
	$( "#region" ).change(function() {
        ...
        $.ajax({ url: "SearchCity.php",
         ...
         function(msg) {
         	...
         	{
         		$('#city').append('<option value="'+city[i].id+'">'+city[i].title+'</option>');
         	}
       	 }
        });
	});	
