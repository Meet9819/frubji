<!-- view -->
  <div class="modal left fade bs-example-modal-lg" id="companylogs<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <center><h4 class="modal-title" id="myModalLabel">View Company Logs </h4></center>
                </div>
                        ...
                        <div class="container-fluid">
                           ...
                           <?php  echo '<div class="row">
                                            <div class="col-md-12 text-center" style="font-size:16px;text-transform:capitalize">
                                                 <span class="txt-dark  mb-5"> '.$erow['companyname_english'].' </span>
                                        ...
                                        '; ?>
                                                    ...
                                                    <div class="history-tl-container">
                                                      ...
                                                      <ul class="tl" style="width: 415px;border-left: 3px dashed #2196F3;">
                                                        ...
                                                        <?php    
                                                        $result = mysqli_query($con,"SELECT * FROM alllogs where whichtable = 'COMPANY' AND idd= $id");
