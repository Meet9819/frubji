 ...
 <!-- view -->
  <div class="modal left fade bs-example-modal-lg" id="salesorderlogs<?php echo $row['order_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <center><h4 class="modal-title" id="myModalLabel">View Sales Order Logs </h4></center>
                </div>
                <div class="modal-body">                 

                        <?php 
                        include('conn.php');
                        $view=mysqli_query($conn,"SELECT * from salesorder where order_id='".$row['order_id']."'");
...
if(isset($row["order_id"]))
{
 ...
 $statement = $connect->prepare("SELECT s.whichcompany as whichcompany, s.order_id as order_id, s.whichbranch as whichbranch, s.soorderprifix as soorderprifix,  c.customername as customername, s.employeeid as employeeid, s.status as status from salesorder s, customer c where c.id = s.customername AND  order_id = :order_id
  LIMIT 1
 ");
 $statement->execute(
  array(
                    ...
                    <div class="row">
                       <div class="col-md-12" style="font-size:16px;text-transform: capitalize;">
                                             ...
                                             Customer:     <span class="txt-dark  mb-5"> '.$row["customername"].'</span> <br>
                                              Document No :   <span class="txt-dark  mb-5">'.$row["whichcompany"].'/'.$row["whichbranch"].'/'.$row["soorderprifix"].'</span> 
...
'; }
                         ...
                         <?php 
                           ...
                           if ($row['status'] == 0 && $row['sales_localrfqid'] == 0) {
                           ...
                           <ul class="list-icons">
                              ...
                              <li class="mb-10"><i class="fa fa-check text-info mr-5"></i> <span   data="" class="btn-sm label label-danger">Sales Order</span></li>
                                          ...
                                          <ul style="margin-left: 25px;" class="list-icons">
                                             ...
                                             <span  class="btn-sm label label-default">SO is Generated</span></li>                                             
                              ...
                              <li class="mb-10"><i class="fa fa-check text-info mr-5"></i> <span   data="" class="btn-sm label label-danger">Sales Order</span></li>
                                          ...
                                          <ul style="margin-left: 25px;" class="list-icons">
                                             ...
                                             <span  class="btn-sm label label-default">SO is Generated</span></li>                                             
                                              ...
                                              <li class="mb-10"><i class="fa fa-times text-danger mr-5 text-info mr-5"></i>
                                             <span  class="btn-sm label label-default">SO is Generated  But Not Approved Neither Mailed</span></li>
                          ...
                          else if ($row['status'] == 1 && $row['sales_localrfqid'] == 0) {
                              ...
                              <li class="mb-10"><i class="fa fa-check text-info mr-5"></i> <span   data="" class="btn-sm label label-danger">Sales Order</span></li>
                                          ...
                                          <ul style="margin-left: 25px;" class="list-icons">
                                             ...
                                             <span  class="btn-sm label label-default">SO is Generated</span></li>                                             
                                              ...
                                              <li class="mb-10"><i class="fa fa-check text-danger mr-5 text-info mr-5"></i>
                                             <span  class="btn-sm label label-default">Local SO Quotation is Generated And Mailed</span></li>

                                             <li class="mb-10"><i class="fa fa-times text-danger mr-5 text-info mr-5"></i>
                                             <span  class="btn-sm label label-default">Generate Delivery</span></li>
                              ...
                              <li class="mb-10"><i class="fa fa-check text-info mr-5"></i> <span   data="" class="btn-sm label label-danger">Sales Order</span></li>
                                          ...
                                          <ul style="margin-left: 25px;" class="list-icons">
                                             ...
                                             <span  class="btn-sm label label-default">SO is Generated</span></li>                                             
                                              ...
                                              <li class="mb-10"><i class="fa fa-check text-danger mr-5 text-info mr-5"></i>
                                             <span  class="btn-sm label label-default">SO is Generated and Mailed</span></li>

                                             
                                          </ul>

                              <li class="mb-10"><i class="fa fa-angle-double-right text-info mr-5"></i> <span  data="" class="btn-sm label label-warning">Delivery Note </span></li>
                          ...
                          else if ($row['status'] == 2 && $row['sales_localrfqid'] == 0) {
                           ...
                           <ul class="list-icons">
                              ...
                              <li class="mb-10"><i class="fa fa-check text-info mr-5"></i> <span   data="" class="btn-sm label label-danger">Sales Order</span></li>
                                          ...
                                          <ul style="margin-left: 25px;" class="list-icons">
                                             ...
                                             <li class="mb-10"><i class="fa fa-check text-danger mr-5 text-info mr-5"></i>
                                             <span  class="btn-sm label label-default">Generated Delivery</span></li>

                                          </ul>

                              <li class="mb-10"><i class="fa fa-check text-info mr-5"></i> <span data="" class="btn-sm label label-warning">Delivery Note </span></li>
                                  ...
                                  <div class="col-md-12"> 
                                                    ...
                                                    <div class="history-tl-container">
                                                      ...
                                                      <ul class="tl" style="width: 415px;border-left: 3px dashed #2196F3;">
                                                        ...
                                                        <?php    
                                                        $result = mysqli_query($con,"SELECT * FROM alllogs where whichtable = 'SALESORDER' AND idd= $id");
