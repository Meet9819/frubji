            ...
            <table id="user_data" class="table table-bordered ">
              <thead>
                <tr>
                  ...
                  <th width="5%">Price</th>
                  <th width="15%">Button Name</th> <th width="5%"> Status</th>
                ...
                <script type="text/javascript">
                  ...
                  if(confirm("Are you sure to "+ msg)){
                    ...
                    url = "allstatus/ecommercesliderajax.php";
                    $.ajax({
                    type:"POST",
                    url: url,
    ...
    <form method="post" id="user_form" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <input type="text" name="buttonname" id="buttonname" class="form-control" />
          <br />
          ...
          <span><b class="txt-danger">* Image size should be 350 x 515 in PNG and Less than 1 MB</b></span>
        </div>
...
<script type="text/javascript" language="javascript" >
  $(document).ready(function(){
  	...
  	var dataTable = $('#user_data').DataTable({
  		...
  		"order":[],
  		"ajax":{
  			url:"ecommerce/slider/fetch.php",
  			type:"POST"
  		},
  		"columnDefs":[
  			{
  	...
  	$(document).on('submit', '#user_form', function(event){
  		...
  		{
  			$.ajax({
  				url:"ecommerce/slider/insert.php",
  				method:'POST',
  	...
  	$(document).on('click', '.update', function(){
  		...
  		$.ajax({
  			url:"ecommerce/slider/fetch_single.php",
  			method:"POST",
  	...
  	$(document).on('click', '.delete', function(){
  		...
  		{
  			$.ajax({
  				url:"ecommerce/slider/delete.php",
  				method:"POST",
  				data:{user_id:user_id},
  				success:function(data)
  				{
