  ...
  <div class="container-fluid">
    <div class="row heading-bg">
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h5 class="txt-dark">Stock Deduction
        </h5>
      </div>
		...
		<form method="post" id="user_form" enctype="multipart/form-data">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">Add stockdeduction</h4>
				</div>
...
$(document).ready(function(){
	$('#add_button').click(function(){
		$('#user_form')[0].reset();
		$('.modal-title').text("Add stockdeduction");
		$('#action').val("Add");
		$('#operation').val("Add");
	...
	var dataTable = $('#user_data').DataTable({
		...
		"order":[],
		"ajax":{
			url:"ecommerce/stockdeduction/fetch.php",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('submit', '#user_form', function(event){
		...
		{
			$.ajax({
				url:"ecommerce/stockdeduction/insert.php",
				method:'POST',
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			url:"ecommerce/stockdeduction/fetch_single.php",
			method:"POST",
			...
			success:function(data)
			{
				...
				$('.modal-title').text("Edit stockdeduction");
				$('#user_id').val(user_id);
	...
	$(document).on('click', '.delete', function(){
		...
		{
			$.ajax({
				url:"ecommerce/stockdeduction/delete.php",
				method:"POST",
				data:{user_id:user_id},
				success:function(data)
				{
