...
$(document).ready(function(){
	...
	var dataTable = $('#user_data').DataTable({
		...
		"order":[],
		"ajax":{
			url:"ecommerce/testimonials/fetch.php",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('submit', '#user_form', function(event){
		...
		if(firstName != '' && lastName != ''  && title != ''  && post != '')
		{
			$.ajax({
				url:"ecommerce/testimonials/insert.php",
				method:'POST',
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			url:"ecommerce/testimonials/fetch_single.php",
			method:"POST",
	...
	$(document).on('click', '.delete', function(){
		...
		{
			$.ajax({
				url:"ecommerce/testimonials/delete.php",
				method:"POST",
				data:{user_id:user_id},
				success:function(data)
				{
