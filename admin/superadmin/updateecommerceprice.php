...
if (!empty($_POST["submit"])) {
  try {
    $update_ecomm_price_master_query = "UPDATE 
      `productsprice` 
    SET 
      `price` = ?,
      `active` = ?
    ...
    $update_ecomm_price_master_query_stmt = mysqli_prepare($conn, $update_ecomm_price_master_query);

    if (!$update_ecomm_price_master_query_stmt) {
      mysqli_rollback($conn);
      throw new \Exception("Error occured while updating ecommerce price master!");
    }
    ...
    for ($i = 0; $i < (int) $_POST["total_records"]; $i++) {
      ...
      mysqli_stmt_bind_param($update_ecomm_price_master_query_stmt, "iid", $price, $active, $row_id);

      if (!mysqli_execute($update_ecomm_price_master_query_stmt)) {
        mysqli_rollback($conn);
        throw new \Exception("Error occured while updating ecommerce price master!");
      }
    }
  ...
  <div class="container-fluid">
    <div class="row heading-bg">
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
        <h5 class="txt-dark">Update Ecommerce Price</h5>
      </div>
      <!-- Breadcrumb -->
      <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
          ...
          <li class="active">Update Ecommerce Price</li>
        </ol>
      </div>
      <!-- Breadcrumb -->
    </div> 
    ...
    <div class="panel panel-default border-panel card-view">
      <div class="panel-wrapper collapse in">
        <div class="panel-body">
          <form name="ecommerce-price-master-update-form" action="" method="post" enctype="application/x-www-form-urlencoded">
                  ...
                  ?>
                    <tr <?php echo ($counter > 1) ? "style='display: none;'" : ""; ?> class="<?php echo "product-row-" . (int) $row['PID']; ?>" data-pid="<?php echo (int) $row['PID']; ?>">
                      ...
                      <td style="padding:10px"> 
                       <b style="display: none"> <?php echo $row['menu_name']; ?> </b>
                      ...
                      <td style="padding:10px">
                        <b style="display: none"> <?php echo $row['name']; ?> </b>
                      ...
                      <td><b style="display: none"> <?php echo $row['units']; ?> </b>
