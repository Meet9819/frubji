        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">View Purchase  Order Item </h4></center>
                </div>
                <div class="modal-body">
				<?php include('conn.php');
					$view=mysqli_query($conn,"SELECT * from purchase_order_item where order_id='".$row['order_id']."'");
            ...
            <?php echo '
                                          ...
                                          <!--  <div class="col-md-2 bor"> Stock in '.$row["requestfrom"].'</div> -->
                                            </div>  
