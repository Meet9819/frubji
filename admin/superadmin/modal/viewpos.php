...
<div class="modal fade bs-example-modal-lg" id="view<?php echo $row['order_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <center><h4 class="modal-title" id="myModalLabel">View POS Item </h4></center>
                </div>
                <div class="modal-body">
				<?php include('conn.php');
				$view=mysqli_query($conn,"SELECT * from pos_item where order_id='".$row['order_id']."'");
                                        ...
                                        <div class="row">
                                            <div class="col-xs-6">
                                                <span class="txt-dark   mb-5">Request From: '.$row["requestfrom"].' </span><br>
                                                  <span class="txt-dark   mb-5">Customer Name: '.$row["customername"].'</span>
                                           ...
                                           <div class="row" style="background-color:#f3f3f3">
                                            ...
                                            $mainstock = $sub_row["currentstock"] / $sub_row['packing'];
                                             ...
                                             <div class="row">                                           
                                                ...
                                                <div class="col-md-6 bor"> '.$sub_row['itemcode'].' - '.$sub_row['item_name'].'</div> 
                                                <div class="col-md-1 bor">  '.$sub_row["order_item_quantity"].' </div> 
                                                <div class="col-md-1 bor">'.$sub_row["units"].'    </div>
                                              
                                                <div class="col-md-1 bor"> '.$sub_row["order_item_price"].'   </div>  
                                                <div class="col-md-1 bor"> '.$sub_row["order_item_actual_amount"].' </div>'; 

                                              /*   if ($mainstock > $order_item_quantity) {
                                                  
                                                   echo '<div class="col-md-2 bor" style="background-color: #06b806;color: white;text-align:right">  '.$mainstock.' </div> ';

                                                } else{
                                                    echo '<div class="col-md-2 bor" style="background-color: red;color: white;text-align:right">  '.$mainstock.' </div> ';
    ...
    '; ?>
            ...
            <?php echo '
                  ...
                  <div class="col-md-12" style="text-align:right;font-size:17px;font-weight:bold">
                <b>Total - '.$row["order_total_after_tax"].'
                 </div>
                  '; 
                echo '
