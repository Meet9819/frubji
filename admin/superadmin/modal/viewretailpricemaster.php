  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-center" id="myModalLabel">View Price Master</h4>
      </div>
                ...
                <div class="panel-wrapper collapse in">
                  ...
                  <div class="panel-body update-form-body">
                    ...
                    <div class="row" style="text-align: right;">
                      <input type="button" value="Update" name="submit" id="submit" class="btn btn-primary btn-rounded retail-price-form-submit-btn">
                    </div>                    
                  </div>
                </div>
              </div>
