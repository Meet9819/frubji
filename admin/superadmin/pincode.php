          ...
          <div class="col-sm-12 text-right">
            <div class="panel panel-default border-panel ">
              <div  class="panel-wrapper collapse in">
               ...
               <!--   <?php include 'importexcel/pincodefunctions.php'; ?>
                  ...
                  <?php include "importexcel/pincoderightmodal.php"; ?> -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h5 class="modal-title">Create pincode 
            </h5>
          </div>
          <div class="modal-body">
            <form method="post" id="user_form" enctype="multipart/form-data">
              <div class="form-group">
                <label for="message-text" class="control-label mb-10">Enter pincode 
                </label>
...
<script type="text/javascript" language="javascript" >
  $(document).ready(function(){
    $('#add_button').click(function(){
      $('#user_form')[0].reset();
      $('.modal-title').text("Add pincode Master");
      $('#action').val("Add");
      $('#operation').val("Add");
    }
                          );
    ...
    $(document).on('click', '.update', function(){
      var id = $(this).attr("id");
      $.ajax({
        url:"onetime/pincodefetch_single.php",
        method:"POST",
        data:{
          id:id}
        ,
        ...
        success:function(data)
        {
          ...
          $('.modal-title').text("Edit pincode Master");
          $('#id').val(id);
          $('#action').val("Update");
          $('#operation').val("Edit");
        }
