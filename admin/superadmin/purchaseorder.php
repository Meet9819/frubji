...
#region queries
$insert_pos_item_record_query = "INSERT INTO `purchaseorder_item`
...
$insert_pos_record_query = "INSERT INTO `purchaseorder`
...
$fetch_pos_invoices_query = "SELECT `order_id` FROM `purchaseorder` ORDER BY `order_id` DESC LIMIT 1";
...
$delete_pos_record_query = "DELETE FROM `purchaseorder` WHERE `order_id` = :id";

$delete_pos_item_records_query = "DELETE FROM `purchaseorder_item` WHERE `order_id` = :id";
            ...
            <div class="table-responsive">
              <div class="row">
                ...
                <div class="col-md-2">
                  ...
                  <select name="type-of-sale" class="form-control">
                    <option value="PURCHASEORDER" selected>PURCHASEORDER</option>
                  </select>
                </div>
                <div class="col-md-1">
                  Date <br />
              ...
              <div class="row" style="padding: 10px 0;">
                <div class="col-md-12 text-center">
                  <a href="purchaseorder.php" class="btn btn-danger btn-rounded btn-lable-wrap left-label">
            ...
            <div class="table-responsive">
              <div class="row">
                ...
                <div class="col-md-2">
                  <b>Type of Sale </b><br />
                  <select name="type-of-sale" class="form-control">
                    <option value="PURCHASEORDER" <?php echo ($pos_order_details["typeofsale"] == "PURCHASEORDER") ? "selected": ""; ?>>PURCHASEORDER</option>
                  </select>
                </div>
                <div class="col-md-1">
                  Date <br />
          ...
          <table id="pos-orders-table" class="table table-bordered table-striped">
            ...
            ?>
              <div class="text-right">
                <a href="purchaseorder.php?add=1" class="btn btn-primary btn-icon right-icon">
                  <i class="fa fa-plus"></i>
                  <span class="btn-text">Create Purchase order</span>
                </a>
              </div><br />
            <?php
              }
            ...
            <tbody>
              ...
              ?>
                <tr>
                  ...
                  <td> <a target="_blank" href="printpdf/print_purchaseorder1.php?pdf=1&id=<?php echo $data["order_id"]; ?>">
                        <i class="fa fa-file-text-o txt-default"> </i>
                      </a></td>
                  <td>
                    <?php
                      if (authorize($_SESSION["access"]["PURCHASE"]["PURCHASEORDER"]["view"])) {
                    ?>
                      <a target="_blank" href="printpdf/print_purchaseorder.php?pdf=1&id=<?php echo $data["order_id"]; ?>">
                        <i class="fa fa-file-text-o txt-default"> </i>
                      </a>
                    <?php 
                      }
                      if (authorize($_SESSION["access"]["PURCHASE"]["PURCHASEORDER"]["edit"])) {
                       
                    ?>
                     &nbsp;&nbsp; <a href="purchaseorder.php?update=1&id=<?php echo $data["order_id"]; ?>" class="text-inverse pr-10">
                        <i class="zmdi zmdi-edit txt-success"></i>
                      </a>
                    <?php
                      
                      }
                      if (authorize($_SESSION["access"]["PURCHASE"]["PURCHASEORDER"]["delete"])) {
                      if ($data['status'] == 0) {
                    ?>
                      <a href="purchaseorder.php?delete=1&id=<?php echo $data["order_id"]; ?>" class="delete">
                  ...
                  <td>
                    <?php
                     if (authorize($_SESSION["access"]["PURCHASE"]["PURCHASEORDER"]["approval"])) {
                    ?>
