                ...
                <table id="user_data" class="table table-bordered ">
                  <thead>
                    ...
                    <th width="50%">Image</th>
							...
							<th width="10%">Link</th> <th width="5%"> Status</th>
...
$(document).ready(function(){
	$('#add_button').click(function(){
		$('#user_form')[0].reset();
		$('.modal-title').text("Add Advertise");
		$('#action').val("Add");
		$('#operation').val("Add");
	...
	var dataTable = $('#user_data').DataTable({
		...
		"order":[],
		"ajax":{
			url:"ecommerce/advertise/fetch.php",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('submit', '#user_form', function(event){
		...
		{
			$.ajax({
				url:"ecommerce/advertise/insert.php",
				method:'POST',
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			url:"ecommerce/advertise/fetch_single.php",
			method:"POST",
	...
	$(document).on('click', '.delete', function(){
		...
		{
			$.ajax({
				url:"ecommerce/advertise/delete.php",
				method:"POST",
				data:{user_id:user_id},
				success:function(data)
				{
