      ...
      <div class="col-lg-4">
        <ul class="xs-top-bar-info right-content">
                           ...
                           <?php
                            if(isset($_SESSION['userSession']))
                            {
                             echo ' <li>  <b>Hi, '.$row['userName'].' </b>   </li>   <li>   <a href="logout.php" title="Sign out"><b> Sign Out</b></a>   </li>                                
                             ';
                            }
                            else{
        ...
        <div class="col-lg-3 col-sm-4 xs-order-1 flex-middle">
          <div class="xs-logo-wraper">
            <a class="xs_default_logo" href="index.php">
              <img  src="" alt="" data-lazy-src="wp-content/logo.png">
            </a>
        ...
        <div class="col-lg-6 col-sm-3 xs-order-3 xs-menus-group">
          <form class="xs-navbar-search xs-navbar-search-wrapper" action="" method="get" id="header_form">
            <div class="input-group">
              ...
              <div class="input-group-btn"> <input type="hidden" id="search-param" name="post_type" value="product"> <button type="submit" class="btn btn-primary"><i style="    margin-top: 10px;" class="fa fa-search"></i></button></div>
            </div>
          </form>
        </div>
        <div class="col-lg-3 col-sm-5 xs-order-2 xs-wishlist-group">
          <div class="xs-wish-list-item">
            <span class="xs-wish-list"> <a href="wishlist.php" class="xs-single-wishList">
             <i class="icon icon-heart"></i> </a> </span>
            <div class="xs-miniCart-dropdown">   
               <a href="viewcart.php" class ="xs-single-wishList offset-cart-menu"><?php echo ' <span class="xs-item-count highlight xscart">'.$cart->total_items().'</span> '; ?> <i class="icon icon-bag"></i> </a></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-lg-3 d-none d-md-none d-lg-block">
          <div class="cd-dropdown-wrapper xs-vartical-menu">
            <a class="cd-dropdown-trigger xs-dropdown-trigger" href="#0"> <i class="fa fa-list-ul"></i> All Categories </a>
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
              ...
              <div class=" ">
                <ul id="main-menu" class="nav-menu lg-menu">
                  <li id="menu-item-478" class="megamenu menu-item menu-item-type-custom menu-item-object-custom menu-item-478"><a title="Home" href="index.php">Home</a></li>
                    <li id="menu-item-478" class="megamenu menu-item menu-item-type-custom menu-item-object-custom menu-item-478"><a title="Home" href="aboutus.php">About us</a></li>
                   ...
                   <li id="menu-item-1133" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1133"><a title="Contact" href="contact.php">Contact</a></li>
        ...
        <div class="col-lg-3 col-lg-3 d-none d-md-none d-lg-block home-v-7">   <a href="sale.php" class="btn btn-primary btn-lg">
         ...
         <div class = "row justify-content-between no-gutters">
            ...
            <ul class = "lists">
              <li>
               ...
               <li>
                  <div class="xs-miniCart-dropdown"> <a href="viewcart.php" class =""> <i class="icon icon-bag"></i> </a></div>
               </li>
            </ul>
         </div>
      </div>
