        ...
        <div class="col-lg-3 col-sm-4 xs-order-1 flex-middle">
          <div class="xs-logo-wraper">
            <a class="xs_default_logo" href="index.php">
              <img style="width: 160px" src="" alt="Frubji" data-lazy-src="wp-content/logo.png">
            </a>
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
              ...
              <div class=" ">
                <ul id="main-menu" class="nav-menu lg-menu">
                  ...
                  <li id="menu-item-576" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-576">
                    <a title="Blog" href="blog.php">Blog</a>
                  </li>
                     ...
                     <div class = "tab-pane fade show active" id="nav-home" role = "tabpanel" aria-labelledby = "nav-home-tab">
                        <div class=" ">
                           <ul id="main-menu" class="nav-menu tab_menu">
                              ...
                              <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-576">
                                 <a title="Blog" href="#">Blog</a>
                                 <ul role="menu" class="nav-dropdown nav-submenu ">
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-575"><a title="Blog" href="blog/index.php">Blog</a></li>
                                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-1161"><a title="Blog Single" href="seating-collection-inspiration-is-not-enough-for-people-2/index.php">Blog Single</a></li>
                                 </ul>
                              </li>
                           </ul>
                        </div>
            ...
            <ul class = "lists">
               <li>
                  <div class = "navSearch-group tab_menu_search">
                     ...
                     <form class="xs-navbar-search xs-navbar-search-wrapper navsearch-form" action="https://wp.xpeedstudio.com/marketo/grocery/" method="get" id="header_forms">
                        <div class="input-group">
                           <input type="search" name="s" class="form-control" placeholder="Find your product">
                           <div class="xs-category-select-wraper">
                              <i class="xs-spin"></i>
               ...
               <li>
                  <div class="xs-miniCart-dropdown"> <a href="cart/index.php" class ="offset-cart-menu"> <i class="icon icon-bag"></i> </a></div>
               </li>
            </ul>
         </div>
      </div>
