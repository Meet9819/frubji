(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($('.ekit-vertical-main-menu-on-click').length > 0) {
            $('.ekit-vertical-main-menu-on-click').each(function () {
                let $this = $(this);
                $(this).find('.xs-vertical-menu-backdrop').on('click', function () {
                    if ($this.hasClass('vertical-menu-active')) {
                        $this.removeClass('vertical-menu-active')
                    }
                })
            })
        }
