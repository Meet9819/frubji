        ...
        <div class="container">
          ...
          <article id="post-822" class="post-content post-single post-822 post type-post status-publish format-standard has-post-thumbnail hentry category-speaker">
                <div class="entry-thumbnail post-media post-image">
                  <a href="blogsdetailpage.php?q='.$row['id'].'" rel="author">  <img width="720" height="394" src="admin/superadmin/ecommerce/blogsimages/'.$row['image'].'"  /></a>
                  ...
                  <header class="entry-header clearfix">
                    <div class="post-meta">
                      <span class="meta-author post-author">
                        <a href="blogsdetailpage.php?q='.$row['id'].'" rel="author"> By Marketo</a>
                      </span>
                      <span class="meta-categories post-cat"> <i class="icon icon-folder"></i> <a href="blogsdetailpage.php?q='.$row['id'].'" rel="category tag">Speaker</a> </span><span class="post-comment"><i class="icon icon-comment"></i> <a href="blogsdetailpage.php?q='.$row['id'].'">0</a></span>
                    </div>
